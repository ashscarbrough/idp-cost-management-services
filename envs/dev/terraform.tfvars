...
cross_account_inventory_role_name = "" # Get these values from the management account setup
cross_account_cleanup_role_name = "" # Get these values from the management account setup
env = "dev"
