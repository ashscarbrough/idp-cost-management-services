...
resource "aws_iam_role" "ami_cleanup_role" {
  name = "ami-cleanup-role"
...
resource "aws_iam_role_policy_attachment" "ami_cleanup_role_policy_attachment" {
  policy_arn = aws_iam_policy.ami_cleanup_policy.arn
  role       = aws_iam_role.ami_cleanup_role.name
}

resource "aws_iam_role_policy_attachment" "ami_read_policy_attachment" {
  role       = aws_iam_role.ami_cleanup_role.name
