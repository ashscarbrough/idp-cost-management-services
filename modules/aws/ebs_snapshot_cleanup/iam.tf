...
resource "aws_iam_policy" "ebs_snapshot_cleanup_policy" {
...
resource "aws_iam_role_policy_attachment" "ebs_snapshot_cleanup_role_policy_attachment" {
  policy_arn = aws_iam_policy.ebs_snapshot_cleanup_policy.arn
  role       = aws_iam_role.ebs_snapshot_cleanup_role.name
}

resource "aws_iam_role_policy_attachment" "ebs_snapshot_read_policy_attachment" {
  role       = aws_iam_role.ebs_snapshot_cleanup_role.name
